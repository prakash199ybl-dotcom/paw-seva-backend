// ============================================================
//   PAW SEVA — routes/users.js
//   User management: list, search, disable, stats
//   CHANGES: search by name/phone/city, disable instead of delete
// ============================================================
...
// Query params: ?search=rahul  OR  ?search=9876  OR  ?search=indore
router.get('/', async (req, res) => {
  try {
    ...
    // Search by name OR phone OR city (case-insensitive)
...
router.get('/stats/overview', async (req, res) => {
  try {
    ...
    res.json({ success: true, stats: { total, donors, volunteers, feeders, ngos, active, disabled } });
  } catch (e) {
    res.status(500).json({ success: false, message: e.message });
  }
});

// ── PATCH disable/enable user (instead of delete) ────────────────────────────
// CHANGE: disable rakho, delete mat karo
